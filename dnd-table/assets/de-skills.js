...
(function (global) {
  ...
  DnD.DE_SKILLS = [
    ...
    { name: '见微知著', en: 'Visual Calculus', group: '智力', base: 1,
      desc: '在脑中重建现场。碎片朝外还是朝里、脚印、角度、弹道。' },
    { name: '标新立异', en: 'Conceptualization', group: '智力', base: 1,
      desc: '抽象思维与艺术感受。把世界看作一个概念。' },
    { name: '故弄玄虚', en: 'Drama', group: '智力', base: 1,
      desc: '谎言与表演。当世界需要你装作另一个人。' },

    /* ---- 精神 ---- */
    { name: '通情达理', en: 'Empathy', group: '精神', base: 3,
      desc: '读懂别人的心。他们在说谎，还是受伤？' },
    { name: '争强好胜', en: 'Authority', group: '精神', base: 2,
    ...
    { name: '平心定气', en: 'Volition', group: '精神', base: 2,
      desc: '精神的盔甲。对抗绝望、恐惧与自我毁灭。' },
    { name: '循循善诱', en: 'Suggestion', group: '精神', base: 1,
      desc: '温柔地推动他人。让人自愿做你希望的事。' },

    /* ---- 体格 ---- */
    { name: '强身健体', en: 'Physical Instrument', group: '体格', base: 2,
      desc: '肌肉的语言。必要时，拳头就是论据。' },
    { name: '坚忍不拔', en: 'Endurance', group: '体格', base: 2,
      desc: '身体扛得住。宿醉、殴打、世界的恶意。' },
    { name: '钢筋铁骨', en: 'Pain Threshold', group: '体格', base: 1,
      desc: '与疼痛共存。伤口只是另一种信号。' },
    { name: '疑神疑鬼', en: 'Half Light', group: '体格', base: 1,
      desc: '战斗本能。世界充满敌意——准备好。' },
    { name: '食髓知味', en: 'Electrochemistry', group: '体格', base: 1,
      desc: '对快感的渴望。酒、烟、多巴胺的呓语。' },
    { name: '鬼祟玲珑', en: 'Savoir Faire', group: '体格', base: 1,
      desc: '风格与街头的智慧。穿得像自己，才配得上自己。' },

    /* ---- 运动 ---- */
    { name: '五感发达', en: 'Perception', group: '运动', base: 3,
      desc: '看见、听见、闻到。细节不会说谎。' },
    { name: '反应速度', en: 'Reaction Speed', group: '运动', base: 2,
      desc: '在事情发生前先动。比子弹快，比巴掌快。' },
    { name: '眼明手巧', en: 'Hand/Eye Coordination', group: '运动', base: 1,
      desc: '让双手做大脑还没想好的事。' },
    { name: '能工巧匠', en: 'Interfacing', group: '运动', base: 1,
      desc: '机械的共情。门锁、收音机、所有会响的物件。' },
    { name: '天人感应', en: 'Shivers', group: '运动', base: 2,
      desc: '与城市本身的连接。瑞瓦肖在你皮肤下颤动。' },
    { name: '同舟共济', en: 'Esprit de Corps', group: '运动', base: 1,
